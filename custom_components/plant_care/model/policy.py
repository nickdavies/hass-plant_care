...
class Policy:
    ...
    The probe's clock is not Home Assistant's — a ten-minute cycle arrives
    anywhere from 9:59 to 10:02 — and moisture is judged over hours, so
    neither a report a few seconds late nor the odd dropped one is worth
    charging against availability. Once a report is judged missed, the
    silence is counted from when it was due, one heartbeat after the last.
    """
